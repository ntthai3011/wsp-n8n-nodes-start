...
function isCredentialClass(node) {
  var _a;
  return ((_a = node.implements) == null ? void 0 : _a.length) === 1 && node.implements[0].type === import_utils.AST_NODE_TYPES.TSClassImplements && node.implements[0].expression.type === import_utils.AST_NODE_TYPES.Identifier && node.implements[0].expression.name === "ICredentialType";
}
...
function isReturnValue(node) {
  var _a;
  return ((_a = node.parent) == null ? void 0 : _a.type) === import_utils.AST_NODE_TYPES.ReturnStatement;
}
function isArgument(node) {
  var _a, _b;
  return ((_a = node.parent) == null ? void 0 : _a.type) === import_utils.AST_NODE_TYPES.TSAsExpression || ((_b = node.parent) == null ? void 0 : _b.type) === import_utils.AST_NODE_TYPES.CallExpression;
}
