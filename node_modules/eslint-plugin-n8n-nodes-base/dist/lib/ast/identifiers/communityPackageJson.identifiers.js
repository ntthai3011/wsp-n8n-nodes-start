...
const prod = {
  isTopLevelObjectExpression(node) {
    var _a, _b;
    return ((_b = (_a = node.parent) == null ? void 0 : _a.parent) == null ? void 0 : _b.type) === import_utils.AST_NODE_TYPES.Program;
  }
};
const test = {
  isTopLevelObjectExpression(node) {
    var _a, _b;
    return ((_b = (_a = node.parent) == null ? void 0 : _a.parent) == null ? void 0 : _b.type) === import_utils.AST_NODE_TYPES.VariableDeclaration;
  }
};
