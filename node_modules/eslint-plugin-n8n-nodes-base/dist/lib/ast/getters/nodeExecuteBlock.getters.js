...
function getMarkedNodeFromConsequent(consequent) {
  ...
  if (((_a = consequent.parent) == null ? void 0 : _a.type) === import_utils.AST_NODE_TYPES.IfStatement && ((_b = consequent.parent) == null ? void 0 : _b.test.type) === import_utils.AST_NODE_TYPES.BinaryExpression && ((_c = consequent.parent) == null ? void 0 : _c.test.operator) === "===" && ((_d = consequent.parent) == null ? void 0 : _d.test.left.type) === import_utils.AST_NODE_TYPES.Identifier && ((_e = consequent.parent) == null ? void 0 : _e.test.left.name) === "operation") {
    return (_f = consequent.parent) == null ? void 0 : _f.test.right;
  }
}
