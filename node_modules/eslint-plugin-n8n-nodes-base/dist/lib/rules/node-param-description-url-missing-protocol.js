...
var node_param_description_url_missing_protocol_default = import_utils.utils.createRule({
  ...
  meta: {
    type: "problem",
    docs: {
      description: `\`description\` in node parameter must include protocol when containing a URL. ${import_constants.DOCUMENTATION.APPLICABLE_BY_EXTENSION_TO_DESCRIPTION_IN_OPTION}`,
      recommended: "error"
    },
    fixable: "code",
    schema: [],
