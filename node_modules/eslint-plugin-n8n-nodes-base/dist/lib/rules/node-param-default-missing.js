  ...
  create(context) {
    return {
      ObjectExpression(node) {
        ...
        if (_default == null ? void 0 : _default.isUnparseable)
          return;
        if (!_default) {
...
function getZerothOption(nodeParamArg) {
  ...
  if (!import_identifiers.id.nodeParam.isOptionsType(nodeParamArg))
    return null;
  return (_b = (_a = import_getters.getters.nodeParam.getOptions(nodeParamArg)) == null ? void 0 : _a.value[0]) != null ? _b : null;
}
