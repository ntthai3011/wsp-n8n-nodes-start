    ...
    return new Promise((resolve, reject) => {
        axiosPromise
            ...
            if (configObject.resolveWithFullResponse === true) {
                ...
                await ((_a = additionalData.hooks) === null || _a === void 0 ? void 0 : _a.executeHookFunctions('nodeFetchedData', [workflow.id, node]));
                resolve({
                    body,
    ...
    return ((workflow, runExecutionData, connectionInputData, inputData, node) => {
        return {
            ...
            helpers: {
                ...getRequestHelperFunctions(workflow, node, additionalData),
                ...getBinaryHelperFunctions(additionalData),
                getBinaryDataBuffer: async (itemIndex, propertyName, inputIndex = 0) => getBinaryDataBuffer(inputData, itemIndex, propertyName, inputIndex),
                returnJsonArray,
                normalizeItems,
...
function getExecuteWebhookFunctions(workflow, node, additionalData, mode, webhookData) {
    return ((workflow, node) => {
        return {
            ...
            getNodeWebhookUrl: (name) => getNodeWebhookUrl(name, workflow, node, additionalData, mode, additionalData.timezone, getAdditionalKeys(additionalData, mode)),
