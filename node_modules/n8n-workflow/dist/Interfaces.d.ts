...
export declare type BinaryFileType = 'text' | 'json' | 'image' | 'video';
...
declare type FunctionsBaseWithRequiredKeys<Keys extends keyof FunctionsBase> = FunctionsBase & {
    [K in Keys]: NonNullable<FunctionsBase[K]>;
};
declare type BaseExecutionFunctions = FunctionsBaseWithRequiredKeys<'getMode'> & {
...
export declare type IExecuteFunctions = ExecuteFunctions.GetNodeParameterFn & BaseExecutionFunctions & {
